resource "azurerm_virtual_network" "vnet" {
  name = (var.virtual_network_name != null && var.virtual_network_name != "") ? 
  "${var.names.product_group}-${var.names.subscription_type}-${var.names.location}-${var.virtual_network_name}" :
  "${var.names.product_group}-${var.names.subscription_type}-${var.names.location}-vnet"
