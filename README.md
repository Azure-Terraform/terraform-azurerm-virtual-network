...
| <a name="input_security_group_perfix"></a> [security\_group\_perfix](#input\_security\_group\_perfix) | Prefix for security group names | `string` | `null` | no |
...
| <a name="input_use_product_name_in_name"></a> [use\_product\_name\_in\_name](#input\_use\_product\_name\_in\_name) | user product\_name as prefix for VNET resource | `string` | `null` | no |
