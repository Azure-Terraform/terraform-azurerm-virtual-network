...
| aks\_subnets | AKS subnets | <pre>object({<br>    private = object({<br>      cidrs             = list(string)<br>      service_endpoints = list(string)<br>    })<br>    public = object({<br>      cidrs             = list(string)<br>      service_endpoints = list(string)<br>    })<br>    route_table = string<br>  })</pre> | `null` | no |
...
| Name | Description |
|------|-------------|
| aks\_subnets | AKS private/public subnet info. |
